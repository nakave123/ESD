				...
				<form:form modelAttribute="job" action="${cp}/new-job"
					...
					<div class="row">
						...
						<div class="col-md-4 mb-3">
							...
							<form:input type="text" path="state" name="state"
								class="form-control" id="state" required="required" />
						</div>
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							...
							<form:input path="openings" name="openings" type="numble"
								class="form-control" id="openings" required="required" />
						</div>

						<div class="col-md-6 mb-3">
							<label for="salary">Salary/Month</label>
							<form:input type="numble" path="salary" name="salary"
								class="form-control" id="salary" required="required" />
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 mb-3">
							...
							<form:select class="custom-select d-block w-100" path="category"
						...
						<div class="col-md-4 mb-3">
							...
							<form:select class="custom-select d-block w-100" path="jobType"
								name="jobType" id="jobType" required="required">
								<option value="">Choose...</option>
						...
						<div class="col-md-4 mb-3">
							...
							<form:select class="custom-select d-block w-100" path="level"
								name="level" id="level" required="required">
								<option value="">Choose...</option>
					...
					<div class="mb-3">
						...
						<form:textarea name="qualifications" path="qualifications"
							class="form-control" id="qualifications" required="required"></form:textarea>
					</div>

					<div class="mb-3">
						<label for="responsibilities">Responsibilities</label>
						<form:textarea name="responsibilities" path="responsibilities"
							class="form-control" value="test" id="responsibilities"
							required="required"></form:textarea>
					</div>

					<div class="mb-3">
						<label for="closeDate">Close Date</label>
						<form:input type="text" class="form-control" path="closeDate"
							name="closeDate" id="closeDate" required="required" />
					</div>

					<hr class="mb-4">
					<button class="btn btn-outline-success btn-lg btn-block" type="submit">Save
						& Post</button>
				</form:form>
			</div>
		</div>
