...
<body class="bg-light">
	...
	<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<a href="${cp}/register" class="btn btn-outline-success mx-2 my-2 my-sm-0"
	...
	<form class="form-signin" action="${cp}/register" method="post" style="background-color: beige;">
		...
		<div class="form-label-group">
			...
			<p style="display: none; color: red" id="pwdErr">Inconsistent
				Password</p>
		</div>
		...
		<div class="float-left">
			<input type="radio" name="role" value="mentor" id="mentor" /> <label
		...
		<button class="btn btn-lg btn-outline-success btn-block" type="submit">Register</button>
	</form>
