	...
	<div class="container" style="background-color: beige;">
		<div class="row justify-content-md-center">
			<div class="col-md-8 order-md-1">
				...
				<sec:authorize access="!isAuthenticated()">
					<a class="btn btn-outline-success btn-lg btn-block" href="${cp}/login"
						role="button">Login To Apply</a>
				</sec:authorize>
					...
					<c:choose>
						<c:when test="${not empty mentee.resumes}">
							<button type="button" class="btn btn-outline-success btn-lg btn-block"
								data-toggle="modal" data-target="#exampleModal">Apply</button>
						</c:when>
						<c:otherwise>
					...
					<form id="applyForm" action="${cp}/job/${job.id}/apply"
						...
						<div class="modal-body">
							...
							<div class="form-group">
								<label for="resumes">Select From My Resumes:</label> <select
									class="custom-select d-block w-100" name="resumeId"
									id="resumes" required="required">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-outline-success" id="apply"
