...
<body class="bg-light">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<sec:authorize access="hasAuthority('mentor')">
						<li class="nav-item"><a class="nav-link" href="mentor">Dashboard</a>
						</li>
					</sec:authorize>
	...
	<main class="jumbotron" style="background-color: beige;">
		<div class="container">
			...
			<p>
				<a class="btn btn-outline-success btn-lg" href="${cp}/new-resume-mentor"
					role="button">New Resume &raquo;</a> <a
					class="btn btn-outline-success btn-lg" href="${cp}/new-mentor-slot"
			...
			<div class="row">
				<c:forEach items="${resumes}" var="resume">
					<div class="col-md-4">
						...
						<a href="${cp}/view-resume/${resume.id}" class="btn btn-secondary">View
							details &raquo;</a>
					</div>
				</c:forEach>
			</div>
					...
					<tbody>
						<c:forEach items="${slots}" var="slot">
							<tr>
								...
								<td>${slot.end}</td>
								<td>${slot.capacity}</td>
								<td><button id="delete-button" onClick()="onclick"
										value="${slot.id}">Delete</button></td>
							</tr>
						</c:forEach>
