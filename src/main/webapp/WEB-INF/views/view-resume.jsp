...
<link type="text/css" rel="stylesheet"
	href="${cp}/resources/css/blue.css" />
<link type="text/css" rel="stylesheet"
	href="${cp}/resources/css/print.css" media="print" />
<!--[if IE 7]>
...
<script type="text/javascript"
	src="${cp}/resources/js/jquery-1.4.2.min.js"></script>
...
<script type="text/javascript"
	src="${cp}/resources/js/jquery.colorbox.js"></script>
		...
		<div class="wrapper-mid">
			...
			<div id="paper">
				...
				<div id="paper-mid">
					<div class="entry">
						<!-- Begin Image -->
						<img class="portrait" src="${cp}/resources/images/image.jpg"
							alt="John Smith" />
						<!-- End Image -->
						...
						<div class="social">
							<ul>
								<li><a class='north' href="#" title="Download .pdf"><img
										src="${cp}/resources/images/icn-save.jpg"
										alt="Download the pdf version" /></a></li>
								<li><a class='north' href="javascript:window.print()"
									title="Print"><img
										src="${cp}/resources/images/icn-print.jpg" alt="" /></a></li>
								<li><a class='north' id="contact" href="contact/index.html"
									title="Contact Me"><img
										src="${cp}/resources/images/icn-contact.jpg" alt="" /></a></li>
								<li><a class='north' href="#" title="Follow me on Twitter"><img
										src="${cp}/resources/images/icn-twitter.jpg" alt="" /></a></li>
								<li><a class='north' href="#" title="My Facebook Profile"><img
										src="${cp}/resources/images/icn-facebook.jpg" alt="" /></a></li>
							</ul>
						</div>
						<!-- End Social -->
					</div>
